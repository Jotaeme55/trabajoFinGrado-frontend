...
export default {
    ...
    methods: {
        async predecir(){
            ...
            let model = await tf.loadLayersModel("../data/detectorPerrosGatos/model.json");
        ...
        fetchItems() {
            this.imagenesService.getImagenesFromUser(this.lazyParams,document.getElementById('BuscadorImagenes').value, this.$store.state.username, "perrosYGatos")
            .then(data => {
